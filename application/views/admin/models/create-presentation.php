        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="session_full_name" id="session_full_name" type="text" class="form-control" aria-label="Session Name">
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">Presentation Title</span>
                    </div>
                    <input name="presentation_title" id="presentation_title" type="text" class="form-control" aria-label="Session Name">
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        ...
                        <input name="room_name" id="room_name" type="text" class="form-control" aria-label="Room Name">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="presentation_date" id="presentation_date" type="date" class="form-control" aria-label="Presentation Date">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="session_start" id="session_start" type="time" class="form-control" aria-label="Session Start Time">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="session_end" id="session_end" type="time" class="form-control" aria-label="Session End Time">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="presentation_start" id="presentation_start" type="time" class="form-control" aria-label="Session Start Time">
                </div>
